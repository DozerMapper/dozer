package net.sf.dozer.eclipse.plugin.editorpage;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import net.sf.dozer.eclipse.plugin.editorpage.pages.DozerConfigurationEditorPage;
import net.sf.dozer.eclipse.plugin.editorpage.pages.DozerMappingEditorPage;
import net.sf.dozer.eclipse.plugin.editorpage.pages.composites.ConfigurationOptionComposite;
import net.sf.dozer.eclipse.plugin.editorpage.pages.composites.FieldOptionComposite;
import net.sf.dozer.eclipse.plugin.editorpage.pages.composites.MappingClassComposite;
...
import net.sf.dozer.eclipse.plugin.editorpage.utils.LazyDomContentProvider;
import net.sf.dozer.eclipse.plugin.editorpage.utils.ObservableUtils;
import net.sf.dozer.eclipse.plugin.editorpage.utils.StringToFieldConverter;
import net.sf.dozer.eclipse.plugin.editorpage.utils.StringToMethodConverter;
