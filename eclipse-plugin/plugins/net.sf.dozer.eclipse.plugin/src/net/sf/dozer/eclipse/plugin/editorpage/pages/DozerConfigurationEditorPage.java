package net.sf.dozer.eclipse.plugin.editorpage.pages;

import net.sf.dozer.eclipse.plugin.DozerPlugin;
import net.sf.dozer.eclipse.plugin.editorpage.DozerFormEditor;
import net.sf.dozer.eclipse.plugin.editorpage.Messages;
import net.sf.dozer.eclipse.plugin.editorpage.actions.PackageExtendAction;
import net.sf.dozer.eclipse.plugin.editorpage.pages.CustomConverterAddDialog.CustomConverterData;
import net.sf.dozer.eclipse.plugin.editorpage.pages.composites.AddRemoveListComposite;
...
import net.sf.dozer.eclipse.plugin.editorpage.utils.ElementAsClassLabelProvider;
import net.sf.dozer.eclipse.plugin.editorpage.utils.TableViewerSelectionListener;
