 ...
 *******************************************************************************/
package net.sf.dozer.eclipse.plugin;
import java.net.URL;
...
public class DozerPlugin extends AbstractUIPlugin {
	...
	public DozerPlugin() {
		plugin = this;
		try {
			resourceBundle = ResourceBundle.getBundle("net.sf.dozer.eclipse.plugin.DozerPluginResources"); //$NON-NLS-1$
	...
	protected void initializeImageRegistry(ImageRegistry registry) {
		...
		registerImage(registry, IMG_ADD_FIELDMAPPING, "attribute.gif", "add.gif"); //$NON-NLS-1$
		registerImage(registry, IMG_ADD_FIELDEXCLUDEMAPPING, "exclude.gif", "add.gif"); //$NON-NLS-1$
