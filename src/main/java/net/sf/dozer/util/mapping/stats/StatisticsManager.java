...
public final class StatisticsManager implements StatisticsManagerIF {
  ...
  /*
   * Convenience method that should only be used for statistic types that
   * will only ever have 1 statistic entry(value).  For stats that only have one entry, it 
   * is assumed that the single entrie's key is the same as the stat type name
   */
  ...
  /*
   * Convenience method that should only be used for statistic types that
   * will only ever have 1 statistic entry(value).  getStatisticEntries() should 
   * be used for statistic types that have more than 1 statistic entry(value) 
   */
