...
/**
 * 
 * Internal class used to read and write values for Map backed objects that use key/value pairs.  The specified "key" is used when invoking getter/setter.
...
public class MapPropertyDescriptor extends GetterSetterPropertyDescriptor {
  ...
  public MapPropertyDescriptor(Class clazz, String fieldName, boolean isIndexed, int index,
      String setMethod, String getMethod, String key) {
