...
public class ObjectFactory extends org.dozer.vo.jaxb.employee.impl.runtime.DefaultJAXBContextImpl {
  ...
  public final static org.dozer.vo.jaxb.employee.impl.runtime.GrammarInfo grammarInfo = new org.dozer.vo.jaxb.employee.impl.runtime.GrammarInfoImpl(
      rootTagMap, defaultImplementations, (org.dozer.vo.jaxb.employee.ObjectFactory.class));
  public final static java.lang.Class version = (org.dozer.vo.jaxb.employee.impl.JAXBVersion.class);

  static {
    defaultImplementations.put((org.dozer.vo.jaxb.employee.EmployeeWithInnerClassType.class),
        "net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl");
    defaultImplementations.put((org.dozer.vo.jaxb.employee.EmployeeWithInnerClass.class),
        "net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeWithInnerClassImpl");
    defaultImplementations.put((org.dozer.vo.jaxb.employee.EmployeeType.class),
        "net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeTypeImpl");
    defaultImplementations.put((org.dozer.vo.jaxb.employee.Employee.class),
        "net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeImpl");
    defaultImplementations.put((org.dozer.vo.jaxb.employee.EmployeeWithInnerClassType.AddressType.class),
    ...
    rootTagMap.put(new javax.xml.namespace.QName("http://jaxb.vo..dozer.sf.net/Employee", "EmployeeWithInnerClass"),
        (org.dozer.vo.jaxb.employee.EmployeeWithInnerClass.class));
    rootTagMap.put(new javax.xml.namespace.QName("http://jaxb.vo..dozer.sf.net/Employee", "Employee"),
        (org.dozer.vo.jaxb.employee.Employee.class));
  }
   ...
   *           if an error occurs
   */
  public org.dozer.vo.jaxb.employee.EmployeeWithInnerClassType createEmployeeWithInnerClassType()
   ...
   *           if an error occurs
   */
  public org.dozer.vo.jaxb.employee.EmployeeWithInnerClassType.AddressType createEmployeeWithInnerClassTypeAddressType()
      throws javax.xml.bind.JAXBException {
