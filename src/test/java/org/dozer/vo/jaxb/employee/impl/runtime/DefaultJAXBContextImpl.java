...
/**
 * This class provides the default implementation of JAXBContext. It also creates the GrammarInfoFacade that unifies all
 * of the grammar info from packages on the contextPath.
 * 
...
public class DefaultJAXBContextImpl extends JAXBContext {
   ...
   * 
   * When more than one package are specified, GrammarInfoFacade is used.
   */
  private GrammarInfo gi = null;

  /**
   * This is the constructor used by javax.xml.bind.FactoryFinder which bootstraps the RI. It causes the construction of
   * a JAXBContext that contains a GrammarInfoFacade which is the union of all the generated JAXBContextImpl objects on
   * the contextPath.
   */
  ...
  /**
   * This constructor is used by the default no-arg constructor in the generated JAXBContextImpl objects. It is also
   * used by the bootstrapping constructor in this class.
   */
  ...
  /**
   * There are no required properties, so simply throw an exception. Other providers may have support for properties on
   * Validator, but the RI doesn't
   */
