 ...
 * 
 * <p>
 * This object coordinates the overall marshalling efforts across different content-tree objects and different target
 * formats.
 * 
 * <p>
 ...
 * 
 * <p>
 * A marshalling of one element consists of two stages. The first stage is for marshalling attributes and collecting
 * namespace declarations. The second stage is for marshalling characters/child elements of that element.
 * 
 * <p>
...
public interface XMLSerializer {
  /**
   * Errors detected by the XMLSerializable should be either thrown as {@link SAXException} or reported through this
   * method.
   * 
   * The callee should report an error to the client application and
   */
   ...
   * 
   * The serializer may or may not check the consistency of ID/IDREFs and may throw a SAXException.
   * 
   * @param owner
   ...
   *          The value of the ID.
   * 
   * @return Return the value parameter without any modification, so that the invocation of this method can be done
   *         transparently by a transducer.
   */
   ...
   * marshalling a content model of an element)
   * 
   * @param fieldName
   *          property name of the parent objeect from which 'o' comes. Used as a part of the error message in case
   *          anything goes wrong with 'o'.
   */
   ...
   * marshalling attributes of an element)
   * 
   * @param fieldName
   *          property name of the parent objeect from which 'o' comes. Used as a part of the error message in case
   *          anything goes wrong with 'o'.
