 ...
 * 
 */
public class ObjectFactory extends net.sf.dozer.vo.jaxb.employee.impl.runtime.DefaultJAXBContextImpl {

  private static java.util.HashMap defaultImplementations = new java.util.HashMap(16, 0.75F);
  private static java.util.HashMap rootTagMap = new java.util.HashMap();
  public final static net.sf.dozer.vo.jaxb.employee.impl.runtime.GrammarInfo grammarInfo = new net.sf.dozer.vo.jaxb.employee.impl.runtime.GrammarInfoImpl(
      rootTagMap, defaultImplementations, (net.sf.dozer.vo.jaxb.employee.ObjectFactory.class));
  public final static java.lang.Class version = (net.sf.dozer.vo.jaxb.employee.impl.JAXBVersion.class);

  static {
    defaultImplementations.put((net.sf.dozer.vo.jaxb.employee.EmployeeWithInnerClassType.class),
        "net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl");
    defaultImplementations.put((net.sf.dozer.vo.jaxb.employee.EmployeeWithInnerClass.class),
        "net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeWithInnerClassImpl");
    defaultImplementations.put((net.sf.dozer.vo.jaxb.employee.EmployeeType.class),
        "net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeTypeImpl");
    defaultImplementations.put((net.sf.dozer.vo.jaxb.employee.Employee.class),
   ...
   *           if an error occurs
   */
  public net.sf.dozer.vo.jaxb.employee.EmployeeWithInnerClassType createEmployeeWithInnerClassType()
      throws javax.xml.bind.JAXBException {
    return new net.sf.dozer.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl();
  }
   ...
   *           if an error occurs
   */
  public net.sf.dozer.vo.jaxb.employee.EmployeeType createEmployeeType() throws javax.xml.bind.JAXBException {
    return new net.sf.dozer.vo.jaxb.employee.impl.EmployeeTypeImpl();
  }
   ...
   *           if an error occurs
   */
  public net.sf.dozer.vo.jaxb.employee.Employee createEmployee() throws javax.xml.bind.JAXBException {
    return new net.sf.dozer.vo.jaxb.employee.impl.EmployeeImpl();
  }
   ...
   *           if an error occurs
   */
  public net.sf.dozer.vo.jaxb.employee.EmployeeWithInnerClassType.AddressType createEmployeeWithInnerClassTypeAddressType()
      throws javax.xml.bind.JAXBException {
    return new net.sf.dozer.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl.AddressTypeImpl();
  }
