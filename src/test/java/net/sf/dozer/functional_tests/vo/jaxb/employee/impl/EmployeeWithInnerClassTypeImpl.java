...
public class EmployeeWithInnerClassTypeImpl implements net.sf.dozer.functional_tests.vo.jaxb.employee.EmployeeWithInnerClassType,
    com.sun.xml.bind.JAXBObject, net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.UnmarshallableObject,
  ...
  protected net.sf.dozer.functional_tests.vo.jaxb.employee.EmployeeWithInnerClassType.AddressType _Address;
  ...
  private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
    return (net.sf.dozer.functional_tests.vo.jaxb.employee.EmployeeWithInnerClassType.class);
  }
  ...
  public net.sf.dozer.functional_tests.vo.jaxb.employee.EmployeeWithInnerClassType.AddressType getAddress() {
    return _Address;
  }

  public void setAddress(net.sf.dozer.functional_tests.vo.jaxb.employee.EmployeeWithInnerClassType.AddressType value) {
    _Address = value;
  }
  ...
  public net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
    ...
    return new net.sf.dozer.functional_tests.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl.Unmarshaller(context);
  }
  ...
  public static class AddressTypeImpl implements net.sf.dozer.functional_tests.vo.jaxb.employee.EmployeeWithInnerClassType.AddressType,
      com.sun.xml.bind.JAXBObject, net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.UnmarshallableObject,
      net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.XMLSerializable,
      net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.ValidatableObject {
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
      return (net.sf.dozer.functional_tests.vo.jaxb.employee.EmployeeWithInnerClassType.AddressType.class);
    }
    ...
    public net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
        net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.UnmarshallingContext context) {
      return new net.sf.dozer.functional_tests.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl.AddressTypeImpl.Unmarshaller(
          context);
    }
    ...
    public class Unmarshaller extends net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.AbstractUnmarshallingEventHandlerImpl {
      ...
      public java.lang.Object owner() {
        return net.sf.dozer.functional_tests.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl.AddressTypeImpl.this;
      }
  ...
  public class Unmarshaller extends net.sf.dozer.functional_tests.vo.jaxb.employee.impl.runtime.AbstractUnmarshallingEventHandlerImpl {
    ...
    public java.lang.Object owner() {
      return net.sf.dozer.functional_tests.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl.this;
    }
    ...
    public void enterElement(java.lang.String ___uri, java.lang.String ___local, java.lang.String ___qname,
      ...
      outer: while (true) {
        ...
        case 10:
          if (("Street" == ___local) && ("" == ___uri)) {
            _Address = ((net.sf.dozer.functional_tests.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl.AddressTypeImpl) spawnChildFromEnterElement(
                (net.sf.dozer.functional_tests.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl.AddressTypeImpl.class), 11, ___uri,
