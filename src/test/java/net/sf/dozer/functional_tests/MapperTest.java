...
import net.sf.dozer.functional_tests.vo.Apple;
import net.sf.dozer.functional_tests.vo.Car;
import net.sf.dozer.functional_tests.vo.CustomConverterWrapper;
import net.sf.dozer.functional_tests.vo.CustomConverterWrapperPrime;
import net.sf.dozer.functional_tests.vo.DehydrateTestObject;
import net.sf.dozer.functional_tests.vo.FurtherTestObject;
import net.sf.dozer.functional_tests.vo.FurtherTestObjectPrime;
import net.sf.dozer.functional_tests.vo.HintedOnly;
import net.sf.dozer.functional_tests.vo.HydrateTestObject;
import net.sf.dozer.functional_tests.vo.NoCustomMappingsObject;
import net.sf.dozer.functional_tests.vo.NoCustomMappingsObjectPrime;
import net.sf.dozer.functional_tests.vo.OneWayObject;
import net.sf.dozer.functional_tests.vo.OneWayObjectPrime;
import net.sf.dozer.functional_tests.vo.Orange;
import net.sf.dozer.functional_tests.vo.TestObject;
import net.sf.dozer.functional_tests.vo.TestObjectPrime;
import net.sf.dozer.functional_tests.vo.TestReferenceFoo;
import net.sf.dozer.functional_tests.vo.TestReferenceFooPrime;
import net.sf.dozer.functional_tests.vo.TestReferenceObject;
import net.sf.dozer.functional_tests.vo.TestReferencePrimeObject;
import net.sf.dozer.functional_tests.vo.TheFirstSubClass;
import net.sf.dozer.functional_tests.vo.Van;
import net.sf.dozer.functional_tests.vo.WeirdGetter;
import net.sf.dozer.functional_tests.vo.WeirdGetter2;
import net.sf.dozer.functional_tests.vo.WeirdGetterPrime;
import net.sf.dozer.functional_tests.vo.WeirdGetterPrime2;
import net.sf.dozer.functional_tests.vo.deep.HomeDescription;
import net.sf.dozer.functional_tests.vo.deep.House;
import net.sf.dozer.functional_tests.vo.deep.Room;
import net.sf.dozer.functional_tests.vo.deep.SrcNestedDeepObj;
import net.sf.dozer.functional_tests.vo.self.Account;
import net.sf.dozer.functional_tests.vo.self.SimpleAccount;
