...
import net.sf.dozer.vo.CustomConverterWrapperPrime;
import net.sf.dozer.vo.DehydrateTestObject;
import net.sf.dozer.vo.FurtherTestObject;
import net.sf.dozer.vo.FurtherTestObjectPrime;
import net.sf.dozer.vo.HintedOnly;
import net.sf.dozer.vo.HydrateTestObject;
import net.sf.dozer.vo.NoCustomMappingsObject;
import net.sf.dozer.vo.NoCustomMappingsObjectPrime;
import net.sf.dozer.vo.OneWayObject;
import net.sf.dozer.vo.OneWayObjectPrime;
import net.sf.dozer.vo.Orange;
import net.sf.dozer.vo.TestObject;
import net.sf.dozer.vo.TestObjectPrime;
import net.sf.dozer.vo.TestReferenceFoo;
import net.sf.dozer.vo.TestReferenceFooPrime;
import net.sf.dozer.vo.TestReferenceObject;
import net.sf.dozer.vo.TestReferencePrimeObject;
import net.sf.dozer.vo.TheFirstSubClass;
import net.sf.dozer.vo.Van;
import net.sf.dozer.vo.WeirdGetter;
import net.sf.dozer.vo.WeirdGetter2;
import net.sf.dozer.vo.WeirdGetterPrime;
import net.sf.dozer.vo.WeirdGetterPrime2;
import net.sf.dozer.vo.deep.HomeDescription;
import net.sf.dozer.vo.deep.House;
import net.sf.dozer.vo.deep.Room;
import net.sf.dozer.vo.deep.SrcNestedDeepObj;
import net.sf.dozer.vo.self.Account;
