...
import net.sf.dozer.vo.recursive.ClassAA;
import net.sf.dozer.vo.recursive.ClassAAPrime;
import net.sf.dozer.vo.recursive.ClassB;
import net.sf.dozer.vo.recursive.ClassBPrime;
