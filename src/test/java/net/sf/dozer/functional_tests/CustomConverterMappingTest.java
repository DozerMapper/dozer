...
import net.sf.dozer.functional_tests.vo.ArrayCustConverterObj;
import net.sf.dozer.functional_tests.vo.ArrayCustConverterObjPrime;
...
import net.sf.dozer.functional_tests.vo.TestCustomConverterObjectPrime;
