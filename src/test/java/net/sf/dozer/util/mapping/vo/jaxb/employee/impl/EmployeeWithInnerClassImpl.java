...
public class EmployeeWithInnerClassImpl
    extends net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl
                ...
                switch (state) {
                    case  1 :
                        if (("FirstName" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl)net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeWithInnerClassImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  3 :
