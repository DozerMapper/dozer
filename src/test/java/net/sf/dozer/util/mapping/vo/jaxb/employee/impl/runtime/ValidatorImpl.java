...
public class ValidatorImpl implements Validator {
  ...
  /**
   * We need to know whether an validation error was detected or not. For this purpose, we set up the validation so that
   * this interceptor will "intercept" errors before the application receives it.
   */
  ...
  public boolean validateRoot(Object o) throws ValidationException {
    if (o == null) {
      throw new IllegalArgumentException(Messages.format(Messages.MUST_NOT_BE_NULL, "rootObj"));
    }
  ...
  public boolean validate(Object o) throws ValidationException {
    if (o == null) {
      throw new IllegalArgumentException(Messages.format(Messages.MUST_NOT_BE_NULL, "subrootObj"));
    }
