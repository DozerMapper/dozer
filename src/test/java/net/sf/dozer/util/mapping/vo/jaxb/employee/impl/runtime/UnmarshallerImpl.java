...
public class UnmarshallerImpl extends AbstractUnmarshallerImpl {
   ...
   * 
   * @return A component that implements both UnmarshallerHandler and ValidationEventHandler. All the parsing errors
   *         should be reported to this error handler for the unmarshalling process to work correctly.
   * 
   * @param locator
   *          The object that is responsible to obtain the source location information for {@link ValidationEvent}s.
   */
