...
public class JAXBBeanFactoryTest extends TestCase {
	...
	public void testCreateBeanForSimpleJaxbClass() {
		...
		Object obj = factory.createBean(null, null, "net.sf.dozer.util.mapping.vo.jaxb.employee.Employee");
		assertNotNull("Object can not be null",obj);
		assertEquals("Invalid class build",obj.getClass().getName(),"net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeImpl" );
	}
	/*
	 *
	 */
	...
	public void testCreateBeanForInnerJaxbClass() {
		...
		Object obj = factory.createBean(null, null, "net.sf.dozer.util.mapping.vo.jaxb.employee.EmployeeWithInnerClassType$AddressType");
		assertNotNull("Object can not be null",obj);
		assertEquals("Invalid class build",obj.getClass().getName(),"net.sf.dozer.util.mapping.vo.jaxb.employee.impl.EmployeeWithInnerClassTypeImpl$AddressTypeImpl" );
	}
