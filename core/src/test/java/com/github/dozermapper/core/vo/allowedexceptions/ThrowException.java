 ...
 */
package com.github.dozermapper.core.vo.allowedexceptions;
...
public class ThrowException {
    ...
    public void setThrowAllowedException(String throwAllowedException) {
        this.throwAllowedException = throwAllowedException;
    }
    ...
    public void setThrowNotAllowedException(String throwNotAllowedException) {
        this.throwNotAllowedException = throwNotAllowedException;
    }
}
