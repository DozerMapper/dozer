...
public class OffsetDateTimeConverterTest {
    ...
    public void testOffsetDateTimeConverter(Object sourceObject, OffsetDateTime expectedResult) throws Exception {
        OffsetDateTime result = (OffsetDateTime) new OffsetDateTimeConverter(DateTimeFormatter.ISO_OFFSET_DATE_TIME).convert(OffsetDateTime.class, sourceObject);
    ...
    public void testOffsetTimeConverter(Object sourceObject, OffsetTime expectedResult) throws Exception {
        OffsetTime result = (OffsetTime) new OffsetDateTimeConverter(DateTimeFormatter.ISO_OFFSET_TIME).convert(OffsetTime.class, sourceObject);
    ...
    private Object offsetTimeTestData() {
        return new Object[][] {
            ...
            {
                Instant.parse("2017-11-02T10:20:30.00Z").toEpochMilli(),
                OffsetDateTime.ofInstant(Instant.parse("2017-11-02T10:20:30.00Z"), ZoneId.systemDefault()).toOffsetTime()
            },
            {
                new Date(Instant.parse("2017-11-02T10:20:30.00Z").toEpochMilli()),
                OffsetDateTime.ofInstant(Instant.parse("2017-11-02T10:20:30.00Z"), ZoneId.systemDefault()).toOffsetTime()
