...
public class ReflectionUtilsTest extends AbstractDozerTest {
  ...
  public void testFindPropertyDescriptor_InterfaceInheritance() throws Exception {
    ...
    PropertyDescriptor pd = ReflectionUtils.findPropertyDescriptor(ChildChildIF.class, fieldName, null).getPd();
  ...
  public void shouldReturnBestMatch_ambigousIgonreCase() {
    ...
    PropertyDescriptor result = ReflectionUtils.findPropertyDescriptor(XMLGregorianCalendar.class, "timezone", null).getPd();
  ...
  public void shouldHandleBeanWithGenericInterface() throws Exception {
    PropertyDescriptor propertyDescriptor = ReflectionUtils.findPropertyDescriptor(Y.class, "x", null).getPd();
